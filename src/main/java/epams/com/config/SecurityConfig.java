...
public class SecurityConfig {
    ...
    @Bean
    public SecurityFilterChain filterChain(final HttpSecurity http) throws CustomGeneralEncryptionException {
        ...
        try {
            ...
            throw new CustomGeneralEncryptionException("Security configuration failed", e);
		} 
