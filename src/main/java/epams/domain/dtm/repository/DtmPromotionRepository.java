...
public class DtmPromotionRepository {
    ...
    public void getPromotionDetail(final DtmPromotionDTO dto) {
        ...
        if(res != null) {
            dto.setFixedDutyAnnualDayRemainCnt(res.getFixedDutyAnnualDayRemainCnt()); //remain_cnt
            ...
            dto.setFixedDutyAnnualHourRemainCnt(res.getFixedDutyAnnualHourRemainCnt()); //remain_hhcnt
