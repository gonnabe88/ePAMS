CREATE TABLE OEHR.THURXE_SESSION (
    ...
    CONSTRAINT OEHR.THURXE_SESSION_PK PRIMARY KEY (PRIMARY_ID)
);
...
CREATE TABLE OEHR.THURXE_SESSION_ATTRIBUTES (
    ...
    CONSTRAINT OEHR.THURXE_SESSION_ATTRIBUTES_PK PRIMARY KEY (SESSION_PRIMARY_ID, ATTRIBUTE_NAME),
    CONSTRAINT OEHR.THURXE_SESSION_ATTRIBUTES_FK FOREIGN KEY (SESSION_PRIMARY_ID) REFERENCES OEHR.THURXE_SESSION(PRIMARY_ID) ON DELETE CASCADE
);
