...
!(function (e, t) {
  ...
  var D = {
    default: {
      ...
      pagination: {
        ...
        all: "전체",
        counter: { showing: "", of: "(총", rows: "개)", pages: "pages" },
      },
  ...
  class H extends F {
    ...
    static initializeModuleBinder(e) {
      H.modulesRegistered ||
        ((H.modulesRegistered = !0),
        H._registerModules(P, !0),
        e && H._registerModules(e));
    }
    ...
    static _registerModuleBinding(e) {
      e.moduleName
        ? (H.moduleBindings[e.moduleName] = e)
        : console.error(
      ...
      if (e.moduleExtensions)
        for (let e in t) {
          ...
          if (H.moduleBindings[e]) for (let t in i) H._extendModule(e, t, i[t]);
            ...
            for (let t in i)
              H.moduleExtensions[e][t] || (H.moduleExtensions[e][t] = {}),
                Object.assign(H.moduleExtensions[e][t], i[t]);
          }
        }
  ...
  function G(e, t) {
    ...
    if (((t = t || ""), Array.isArray(e)))
      ...
      for (var s in e) i = i.concat(G(e[s], t ? t + "[" + s + "]" : s));
    else i.push({ key: t, value: e });
    return i;
  }
  var U = {
  ...
  class Z extends M {
    ...
    initializeColumn(e) {
      ...
      if (t.topCalc) {
        switch (typeof t.topCalc) {
          case "string":
            Z.calculations[t.topCalc]
              ? (i.topCalc = Z.calculations[t.topCalc])
              : console.warn(
      ...
      if (t.bottomCalc) {
        switch (typeof t.bottomCalc) {
          case "string":
            Z.calculations[t.bottomCalc]
              ? (i.botCalc = Z.calculations[t.bottomCalc])
              : console.warn(
                  "Column Calc Error - No such calculation found, ignoring: ",
                  t.bottomCalc
                );
    ...
    generateRow(e, t) {
      ...
      return (
        ...
        (i.component = !1),
        (i.getComponent = () => (
          i.component || (i.component = new $(i)), i.component
        )),
        (i.generateCells = () => {
          var t = [];
  ...
  let se = class {
    ...
    _createInputElement() {
      ...
      return (
        this.params.mask && ie(t, this.params), this._bindInputEvents(t), t
      );
    }
    _initializeParams(e) {
      var t,
      ...
      switch (typeof e.definition.editor) {
        case "string":
          this.editors[e.definition.editor]
            ? (i.editor = this.editors[e.definition.editor])
            : console.warn(
          ...
          !0 === e.definition.editor &&
            ("function" != typeof e.definition.formatter
              ? this.editors[e.definition.formatter]
                ? (i.editor = this.editors[e.definition.formatter])
        ...
        t.forEach((e) => {
          ...
          e.forEach((e) => {
            if (e) {
              ...
              t.push(
                new ae(i, e.column.getComponent(), e.width, e.height, e.depth)
              );
            } else t.push(null);
          }),
  ...
  class ye extends M {
    ...
    lookupImporter(e) {
      ...
      return (
        ...
        (t = "string" == typeof e ? ye.importers[e] : e) ||
  ...
  class Pe extends M {
    ...
    initializePageCounter() {
      var e = this.table.options.paginationCounter,
        t = null;
      e &&
        ((t = "function" == typeof e ? e : Pe.pageCounters[e])
          ? ((this.pageCounter = t),
  ...
  var We = {
    ...
    time: function (e, t, i, s, o, n, r) {
      return (
        r.format || (r.format = "HH:mm"), Ne.call(this, e, t, i, s, o, n, r)
      );
    },
    datetime: Ne,
  ...
  class je extends M {
    ...
    initializeColumn(e) {
      ...
      switch (typeof e.definition.sorter) {
        case "string":
          je.sorters[e.definition.sorter]
            ? (s = je.sorters[e.definition.sorter])
            : console.warn(
    ...
    SelectRangeModule: class extends M {
            ...
            ? ((l = this.getRowByRangePos(o.end.row)),
              ...
              null !== h.getElement().parentNode
                ? ("up" !== i && "down" !== i) ||
                  ...
                  ? this.autoScroll(o, l.getElement(), h.getElement())
      ...
      autoScroll(e, t, i) {
        ...
        void 0 === t && (t = this.getRowByRangePos(e.end.row).getElement()),
          ...
          r ||
            (o.left < n.left
              ? ((l.scrollLeft = o.left), s && (l.scrollLeft -= s.offsetWidth))
              : o.right > n.right && (l.scrollLeft = o.right - l.clientWidth)),
          a ||
            (o.top < n.top
              ? (l.scrollTop = o.top)
              : o.bottom > n.bottom &&
