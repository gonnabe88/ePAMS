...
class EPamMemberTests {
        ...
        public void RegistOneMember() throws IOException {
                ...
                for (int i = 1; i <= 200; i++) {
                        for (int j = 1; j <= 25; j++) {
                                final TempUserEntity member3 = TempUserEntity.builder()
                ...
                final TempUserEntity member2 = TempUserEntity.builder()
                                .username("K140024")
                                .password(passwordEncoder.encode("kdb1234!"))
                                .dept("디지털금융부")
                                .team("지식정보팀")
                                .responsibility("급여,복리후생,채용 등")
                                .role(TempRoleDTO.ROLE_ADMIN)
                                .build();
